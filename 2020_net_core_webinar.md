...
- [ExternalDefinitionCreationOptions.GUID Property](https://www.revitapidocs.com/2024/c86d0033-8200-15ee-070c-d0a606ed3b2a.htm) → C# `public Guid GUID { get; set; }`
...
![Parameter Service](img/archi_param_service.jpg "Parameter Service")
#### Happy Holidays!
I wish you a peaceful end of the year,
calm [twelve nights](https://en.wikipedia.org/wiki/Twelfth_Night_(holiday)) and
restful holidays!
![Dino in snow](img/dino_in_snow_669_cropped_500.jpg "Dino in snow")