...
- **SD195990** Revit API Expert Roundtable: Open House on the Factory Floor
![Revit API Panel at AU in Las Vegas](img/2018-11-15_revit_api_panel_recording_au_las_vegas.jpg)
...
– ignoring the fact that we don't know what 'revives' might be (reviews?):
...
by [issue #45 – Center parent for forms](https://github.com/jeremytammik/RevitLookup/issues/45) raised
by [TheKidMSX](https://github.com/TheKidMSX), who also provided
the [pull request #46 – Forms startposition correction](https://github.com/jeremytammik/RevitLookup/pull/46) including the fixes.
