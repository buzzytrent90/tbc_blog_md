...
![Dimension hatch on floor](img/dim_hatch_linked_model_ceiling.png "Dimension hatch on floor")
...
![Stable representation in linked file](img/dim_hatch_linked_model_ceiling_stable_rep.png "Stable representation in linked file")
...
This is the pattern:
![Final solution code](img/dim_hatch_linked_model_final.png "Final solution code")
...
`link_doc.ActiveView.Id` produces a `NoneType` error –
