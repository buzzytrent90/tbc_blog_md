...
tags: ['geometry', 'parameters', 'references', 'revit-api', 'schedules', 'sheets', 'views', 'walls']
source_file: "1695_da4r.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1695_da4r.html"
---
...
This is all based on last year's presentation ***SD125457** – Design Automation – Building Web Applications with Revit Data on Forge\* by Diane Christoforo, Sasha Crotty, Rahul Bhobe and Ryan Duell at Autodesk University last year in Las Vegas.
...
#### What is Forge Design Automation API for Revit?
...
Like other Forge services, you’ll create a Forge client application which will call our REST API endpoints. You can use any language which can make REST calls. This client application will also do any 'front-end' work you need – displaying UI to an end-user, for example. Overall, the
...
#### Workflow: Uploading a Revit add-in
![Uploading an AppBundle](img/da4r_upload_appbundle.png)
...
![Running a workitem](img/da4r_running_workitem.png)
...
#### Things to consider when using the service
...
#### Decide what your add-in will do
...
#### Determine what inputs you need
...
#### Use our bridge library to be notified when Design Automation is executing
...
#### Decide how to handle logging and errors specific to your add-in
...
#### Plan how to access or create files
...
#### Move any Internet operations to the client application
...
- [Design Automation for Revit – DA4R](#12)
- [Getting started – Step by Step](#13)
...
1. [Convert your Revit AddIn](zip/da4r_au_2018/ConvertAddin.html) – Applications run on Design Automation are very similar to normal Revit addins.
2. [Create a Forge App and get authenticated](zip/da4r_au_2018/Forge.html) – Design Automation runs on the Autodesk Forge platform, so you need an account and access to the pricvate DA4R beta.
...
- [nickname](zip/da4r_au_2018/Nickname.html) – A way to map a Forge App `Client Id` to a customized string. The nickname lets you create a friendly, easy-to-read, string that can be used in place of the long Forge App `Client Id`.
- [alias](zip/da4r_au_2018/Alias.html) – A label to a specific version of an `app` or `activity`.
- [app](zip/da4r_au_2018/AppBundle.html) – A package of binaries and supporting files which make your Revit Addin application.
- [activity](zip/da4r_au_2018/Activity.html) – An action which can be executed in Design Automation. You create and post your own activities to run against particular `apps`.
- [workitem](zip/da4r_au_2018/WorkItem.html) – A request to execute an `activity`. The relationship between an activity and workitem can be thought of as a 'function definition' and 'function call', respectively.
...
#### Handling Failures in Revit App Bundles
