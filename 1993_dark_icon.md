...
- [Dark theme icons](#2)
- [Hack 1 – dark icons by ImageMagick](#2.1)
- [Hack 2 – embed name in `BitMapSource`](#2.2)
...
![NewFamilyInstance moved](img/kc_newfamilyinstance_moved.png "NewFamilyInstance moved")
