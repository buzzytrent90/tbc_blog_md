...
![Good slabs in Revit 2015](img/exorbitant_2015_slabs_good.jpg)
In Revit 2016, the slabs are displayed incorrectly and look like this:
![Bad slabs in Revit 2016](img/exorbitant_2016_slabs_bad.jpg)
If you hover the mouse over a slab in Revit 2016, the blue selection outline shows the correct slab geometry:
![Hovering over slabs in Revit 2016](img/exorbitant_2016_hover_slab_correct_outline.jpg)
...
#### Why the Limit?
\*\*Question:\*\* David Veld asks [below](http://thebuildingcoder.typepad.com/blog/2017/11/avoid-exorbitant-coordinates.html#comment-3639729627): I've always wondered where this 20 mile limit comes from, from a coding-technical point of view. If Revit is written in native C++ and stores its coordinates in feet, as doubles, the limit should be 1.8 × 10^308 (right?) – this is waaaay beyond 20 miles. Or does this mean they are not and perhaps stored in another way?
...
by importing a DWG file – however, please also be aware that it is in general recommended
