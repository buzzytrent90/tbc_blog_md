...
[![Gross Spannort](https://c2.staticflickr.com/9/8614/28245261321_169d513752_n.jpg)](https://www.flickr.com/photos/jeremytammik/albums/72157670398939461 "Gross Spannort")
Back to the Forge, Revit and IFC related programming topics:
- [Autodesk Forge Platform — Little machines](#2)
...
![IFC pipes and elbow in A360](img/simple_pipe_elbow_mh_a360.png)
...
#### IFC Family Support Discussion Links
...
- [IFC for Revit – Support for Revit Groups?](https://sourceforge.net/p/ifcexporter/discussion/general/thread/fad5b2f8)
- [BuildingSMART/mvdXML issue #3 – Possible to outline an MVD exchange requirement to address the concept of groups? ](https://github.com/BuildingSMART/mvdXML/issues/3)
- [BuildingSMART/IFC4-CV issue #16 – Support for a One-to-Many (non-type) of Group](https://github.com/BuildingSMART/IFC4-CV/issues/16)
- [FreeCAD – Convert IfcGroups into FreeCAD Compounds](http://forum.freecadweb.org/viewtopic.php?f=23&t=12131)
- [IndustryFoundationClasses/Questions issue #3 – Suggested IFC Entity to save a Profile Type](https://github.com/IndustryFoundationClasses/Questions/issues/3)