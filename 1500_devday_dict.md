...
- [Storing a dictionary – use `DataStorage`, not `ProjectInfo`](#5)
...
- DevDay conference – December 5, 2016
- DevLab and Forge Accelerator – December 6-9, 2016
...
all further details.
![AEC Symposium](img/2016-12_core_tt_aec_symposium.jpg)
