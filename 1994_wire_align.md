...
![Electrical wire collector](img/electrical_wire_collector.png "Electrical wire collector")

Electrical wire collector
...
```
  private List WireCollector( ForEachView viewPlan )
  {
    List wireCollector
    ...
    if ( viewPlan.PrimaryPlan != ElementId.InvalidElementId )
    {
      ...
      List filteredWires = wireCollector
...
going from the panelboard to each receptacle – I'd like to show them daisy-chained together
...
![Nearest Neighbor](img/pr_circuit_nearest_neighbour.png "Nearest Neighbor")

Nearest Neighbor

![Minimum Spanning Tree](img/pr_circuit_minimum_spanning_tree.png "Minimum Spanning Tree")

Minimum Spanning Tree

![Star Connected](img/pr_circuit_star_connected.png "Star Connected")
...
![Delaunay algorithm](img/pr_circuit_ricaun_delaunay.png "Delaunay algorithm")
...
Thanks for the help!
![Desired Result](img/pr_circuit_desired_result.png "Desired Result")
...
![Problem Case](img/pr_circuit_problem_case.png "Problem Case")
...
![Align element – not aligned](img/align_element_1.png "Align element – not aligned")

Align element – not aligned

This is how I want the column to be aligned to the `ModelCurve`:
![Align element](img/align_element_2.png "Align element")
