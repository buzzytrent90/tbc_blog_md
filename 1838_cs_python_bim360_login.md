...
the [Bad Monkeys](https://www.badmonkeys.net) (not to be confused with the [thriller of the same name](https://en.wikipedia.org/wiki/Bad_Monkeys) – featuring Jane, who claims that she works for a secret organization devoted to fighting evil and that she is the operative for the Department for the Final Disposition of Irredeemable Persons, also known as Bad Monkeys):
...
Thank you!
![Bad Monkeys book cover](img/Bad_Monkeys_2007_book_cover.jpg "Bad Monkeys book cover")
...
on [IronPython – Visual Studio 2010 or SharpDevelop?](https://stackoverflow.com/questions/2851898/ironpython-visual-studio-2010-or-sharpdevelop).
