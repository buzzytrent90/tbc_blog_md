...
tags: ['elements', 'geometry', 'parameters', 'references', 'revit-api', 'sheets', 'transactions', 'views']
source_file: "1906_lookup_2022.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1906_lookup_2022.html"
---
...
- [2022.0.0.1](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.1) – integrated pull request #74 by @peterhirn setting up CI for Revit 2022
- [2022.0.0.2](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.2) – integrated pull request #75 by @peterhirn to fix CI for Revit 2022 and non-dotnet-core project file
- [2022.0.0.3](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.3) – integrated pull request #73 implementing temporary transaction and rollback allowing to snoop PlanTopology, reset Revit API assembly DLL references to Copy Local false and specified Configuration as 2022
- [2022.0.0.4](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.4) – upgraded to Visual Studio 2019 (from 2017) and adopted @peterhirn project and solution files
- [2022.0.0.5](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.5) – integrated pull request #76 by @peterhirn to fix CI for new VS 2019 Revit 2022 dotnet-core csproj
- [2022.0.0.6](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.6) – integrated pull request #77 by @RevitArkitek to get end points for curves
- [2022.0.0.7](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.7) – integrated pull request #78 by @RevitArkitek to handle TableData.GetSectionData
- [2022.0.0.8](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.8) – integrated pull request #80 by @WspDev to remove deprecated ParameterType usage
- [2022.0.0.9](https://github.com/jeremytammik/RevitLookup/releases/tag/2022.0.0.9) – integrated pull request #81 by @CADBIMDeveloper enhancing ElementId and Revit 2022 extensible storage support:
...
![Extensible storages fields](img/revitlookup_pr_81_1.png "Extensible storages fields")
Now RevitLookup also supports `Dictionary` `KeyValuePairs` lookup.
That is useful to view extensible storage entity data:
![Dictionary KeyValuePairs lookup](img/revitlookup_pr_81_2.png "Dictionary KeyValuePairs lookup")
...
![SetGeometryCurve overrideJoins](img/SetGeometryCurve_overrideJoins.png "SetGeometryCurve overrideJoins")
