...
- [Connecting BIM and Cloud @ **TUDa**](#3)
...
[![Last Night and Morning at RTC](https://c4.staticflickr.com/6/5833/30400227011_e5d736383c_n.jpg)](https://www.flickr.com/photos/jeremytammik/albums/72157674181041821 "Last Night and Morning at RTC")
...
- Revit API – [creating a Revit add-in with one single click](#4)
- Connecting BIM with the cloud – [connecting Revit and Forge in 55 minutes](#5)
...
- [DevTV – Introduction to Revit Programming](https://www.youtube.com/watch?v=l8dQxoAjSP8)
- [DevTV – Introduction to Revit Programming Part 2](https://www.youtube.com/watch?v=zL8pQRJbcyA)
...
- Install the Revit API help file `RevitAPI.chm` as a desktop shortcut and keep at hand at all times, or refer to the [online Revit API documentation at www.revitapidocs.com](http://www.revitapidocs.com).
- Install the SDK samples solution `SDKSamples.sln` for global source code searches.
- Install the `RvtSamples` external application to launch and debug the SDK samples.
...
- The Revit SDK provides the basic Revit API help file documentation in `RevitAPI.chm`.
