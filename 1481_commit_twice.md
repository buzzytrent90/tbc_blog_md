...
- [Connecting desktop and cloud – Roomedit3dv3 live](#4)
...
The viewer is not intended to be a standalone multi-format viewer – it is intended to be used in conjunction with the Model Derivative API.
...
- Oct. 18-19 – Forge and BIM, [ISEPBIM](https://www.facebook.com/ISEPBIM) at [ISEP](http://www.isep.ipp.pt), Porto University
- Oct. 20-22 – [RTCEU Revit Technology Conference Europe](http://www.rtcevents.com/rtc2016eur), Porto
- Oct. 24-28 – [Forge Accelerator](http://autodeskcloudaccelerator.com), Munich
- Nov. 4 – Forge and BIM Workshop, [Darmstadt University](http://www.tu-darmstadt.de)
- Nov. 14-17 – [Autodesk University](http://au.autodesk.com), Las Vegas
- Dec. 5 – [DevDay Europe](http://autodeskdevdays.com/devdays-2016), Munich
- Dec. 6-9 – [DevDay Forge Accelerator](http://autodeskdevdays.com/accelerator), Munich
...
![RTC Europe 2016](img/RTC-EUR-2016-240w.png)