...
- RAM: 32.0 GB
- OS: Windows 10 Pro
The call to *BooleanOperationsUtils.ExecuteBooleanOperation(solidST, solidAR, BooleanOperationsType.Intersect)*
...
![JtClicker handles it](img/jc_error_msg.png "JtClicker handles it")
