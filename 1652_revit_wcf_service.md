...
- RevitExternalAccessClient – client application, a console app that calls WCF service methods
...
/// summary>
IEnumerable GetAllExteriorWalls(
Document doc )
{
...
![Third party shared parameter](img/third_party_shared_parameter.png)
