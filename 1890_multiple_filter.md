...
![Two Jeremys](img/top_solution_authors_two_jeremys_3.png "Two Jeremys")
...
![Rain water collector](img/rain_water_collector_sheet.jpg "Rain water collector")
...
He submitted the [issue #68 – split region offsets (2021)](https://github.com/jeremytammik/RevitLookup/issues/68) and a
subsequent [pull request – adds handler for `GetSplitRegionOffsets`](https://github.com/jeremytammik/RevitLookup/pull/69),
explaining:
...
![Autotagging spiral](img/autotagging_spiral.png "Autotagging spiral")
...
implementing [custom errors – preventing specific changes to the Revit model](https://boostyourbim.wordpress.com/2021/01/28/custom-errors-preventing-specific-changes-to-the-revit-model),
explaining:
...
![Custom error](img/hm_custom_error.png "Custom error")
