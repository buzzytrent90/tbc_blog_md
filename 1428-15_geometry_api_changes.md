...
optimization_date: '2025-12-11T11:24:11.670655'
...
post_number: '1428'
series: geometry
slug: whats_new_2017_geometry_api_changes
...
- walls
- windows
title: API Changes - Geometry API changes
word_count: 251
---
...
- NurbSpline.Create(IList controlPoints, IList weights, IList knots, int degree, bool closed, bool rational) → NurbSpline.CreateCurve(int degree, IList knots, IList controlPoints, IList weights); Two arguments were removed:
...
- NurbSpline.Create(IList controlPoints, IList weights, IList knots, int degree, bool closed, bool rational) → NurbSpline.CreateCurve(int degree, IList knots, IList controlPoints); This version can be used in the common case when rational = false and all the weights are 1.
- NurbSpline.Create(IList controlPoints, IList weights) → NurbSpline.CreateCurve(IList controlPoints, IList weights)
#### TessellatedShapeBuilder changes
The method Build() has changed from the prior release as follows:
- \*\*Deprecated member → New or replacement member\*\*
- TessellatedShapeBuilder.Build(TessellatedShapeBuilderTarget, TessellatedShapeBuilderFallback, ElementId) → TessellatedShapeBuilder.Build()
