...
**[A]** Revit2017AddInTemplateSet is not based on the VisualStudioRevitAddinWizard. Revit2017AddInTemplateSet has other architecture and ideas.
...
**[Q]** If possible, I imagine it would be useful for the entire Revit API developer community if we can manage to maintain a single optimal set of Wizards that satisfies all needs.
...
![Debugging options](img/0_vs_debugging_options.png)
...
Autodesk is seeking a [Machine Learning Software Engineer for a post in Neuchâtel](https://autodesk.taleo.net/careersection/adsk_gen/jobdetail.ftl?job=17WD22765).
