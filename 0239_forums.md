...
As you have seen in the past year and more, I am more than happy to answer any questions I can on the Revit API submitted in comments to this blog.
...
I occasionally also receive emails with questions.
...
And obviously, before you ask any questions at all, you can often save yourself and others some unnecessary effort by searching existing resources for answers.
An efficient tool for finding answers on Revit API programming topics is Rod Howarth's
[global online Revit API help](http://www.google.com/coop/cse?cx=003379886482190238526:wi7yjrtrkd8)
described in this
[previous post](http://thebuildingcoder.typepad.com/blog/2009/08/online-revit-api-help.html).

Here are some examples:

**Question:** I have some questions about sending and receiving keyboard input in Revit.
...
I found some resolution of this problem but it still isn't a good idea.

**Answer:** This is a question that is a bit too vague for me to say anything about directly.
...
For instance, you can open a thread on AUGI, the
[Autodesk Users Group International](http://forums.augi.com).
AUGI provides a large number of dedicated forums for discussions on topics such as
[Revit](http://forums.augi.com/forumdisplay.php?f=93), with numerous subtopics including the
[Revit API](http://forums.augi.com/forumdisplay.php?f=218),
and also lots of
[international forums](http://forums.augi.com/forumdisplay.php?f=72).

You can also initiate a discussion in one of the
[Autodesk discussion groups](http://discussion.autodesk.com),
for instance on the topic of Revit Architecture or the Revit API.

Here is a
[comment by Vincent](http://thebuildingcoder.typepad.com/blog/2009/10/namespaces.html?cid=6a00e553e1689788330120a686c282970c#comment-6a00e553e1689788330120a686c282970c) providing
...
**Answer:** The short answer is no, sorry.
I'm in Switzerland, in Europe.
Some of the people I talk with may or may not be in your area, but I really don't know.

I completely agree with your assessment that it is not hard to make use of the API once you have gone through the
...
You might be able to find someone in the
[ADN member database](http://www.autodesk.com/partnerproducts).
...
[Revit](http://forums.augi.com/forumdisplay.php?f=93) or the
[Revit API](http://forums.augi.com/forumdisplay.php?f=218),
or possibly searching the AUGI web site globally for Los Angeles or something.

#### Autodesk Developer Network

At this point, I should not forget to mention my real work, which is providing developer support as part of the AEC workgroup of the DevTech team for ADN, the
...
- Access to almost all Autodesk software and SDKs, including early access to Beta software- Members-only website with thousands of technical articles- Unlimited technical support- Product direction through conferences- Marketing benefits- Exposure on autodesk.com- Promotional opportunities- 1 to 3 free API training classes

You dont have to be a commercial software developer to join ADN.
