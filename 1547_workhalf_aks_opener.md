...
on [giving back – a workshared file to be local file opener](https://forums.autodesk.com/t5/revit-api-forum/giving-back-a-workshared-file-to-be-local-file-opener/m-p/6990230):
...
![RevitAKSOpen GenieOpener](img/akseidel_AKSOpen3.png)
#### Why?
...
![RvtFader ribbon tab](img/rvtfader_ribbon_tab.png)
...
![Signal attenuation calculated and displayed by RvtFader](img/rvtfader_result.png)
#### ForgeFader
...
![Signal attenuation calculated and displayed by ForgeFader](img/forgefader_test_result.png)
