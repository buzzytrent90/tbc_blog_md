...
raised [issue #59 – continuous integration no longer working](https://github.com/jeremytammik/RevitLookup/issues/59),
caused by Harry Mattison's preceding [pull request #58 – solution changes for multi-release building](https://github.com/jeremytammik/RevitLookup/pull/58),
...
in [pull request #61 – move CI to `gitlab.com`](https://github.com/jeremytammik/RevitLookup/pull/61):
...
![GitLab functionality](img/gitlab_functionality.png "GitLab functionality")
#### GraphQL for Revit
...
![BIMrx Marconi](img/BIMrx_marconi.jpg "BIMrx Marconi")
