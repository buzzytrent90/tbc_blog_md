...
> We're hiring!
I strongly believe that the tools we will be building on this team are critical to the future of building design – and improving the state of the planet in the future.
...
![Unload IFC link to delete extensible storage](img/unload_ifc_to_delete_estorage_1.png "Unload IFC link to delete extensible storage")![Unload IFC link to delete extensible storage](img/unload_ifc_to_delete_estorage_2.png "Unload IFC link to delete extensible storage")![Unload IFC link to delete extensible storage](img/unload_ifc_to_delete_estorage_3.png "Unload IFC link to delete extensible storage")![Unload IFC link to delete extensible storage](img/unload_ifc_to_delete_estorage_4.png "Unload IFC link to delete extensible storage")![Unload IFC link to delete extensible storage](img/unload_ifc_to_delete_estorage_5.png "Unload IFC link to delete extensible storage")
...
- Whether in a workplace or a relationship, feedback – honest, no-B.S. insight on what you could do better – is priceless.
...
It makes the person giving it feel unheard – and less likely to shoot straight with you in the future.
- Ask for it.
You're more likely to get feedback if you ask peers or superiors – in a sincere, humble, open-minded way – how you could be more effective.
