...
- [Task – 2D polygon representing birds-eye view of an element](#2)
...
- [CmdExtrusionAnalyzer](#3) – generate element outline using `ExtrusionAnalyzer`
- [Cmd2dBoolean](#5) – generate element outline using 2D Booleans
- [CmdRoomOuterOutline](#6) – outer room outline using 2D Booleans
...
#### Task – 2D Polygon Representing Birds-Eye View of an Element
...
![Apartment layout showing birdseye view of accessories](img/apartment_layout.png "Apartment layout showing birdseye view of accessories")
...
![Plan view of desk and chair in Revit](img/desk_and_chair_plan.png "Plan view of desk and chair in Revit")
The loops exported by the RoomEditorApp add-in for the same desk and chair look like this instead:
![Desk and chair loops in GeoSnoop](img/desk_and_chair_loops.png "Desk and chair loops in GeoSnoop")
...
![Four elements selected for extrusion analyser](img/element_outline_four_selected_extrusion_analyser_svg_path.png "Four elements selected for extrusion analyser")
...
![GeoSnoop outlines generated from solids versus 2D Booleans](img/geosnoop_solids_versus_booleans.png "GeoSnoop outlines generated from solids versus 2D Booleans")
...
![Wall width sample loop](img/wall_width_loop_using_2d_booleans.png "Wall width sample loop")
It also gracefully handles the room separator situation:
![Room separator sample loop](img/room_separator_using_2d_booleans.png "Room separator sample loop")
#### Conclusion
