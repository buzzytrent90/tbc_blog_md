...
IList sbList = sbFarClip.GetItems();
...
He provided the [SplitButtonOptionConcept](zip/as_SplitButtonOptionConcept.zip)Visual Studio solution implementing a full sample Revit add-in demonstrating the concept.
...
![SplitButtonOptionConcept ribbon panel](img/split_button_options_panel.png)
...
![SplitButtonOptionConcept buttons](img/split_button_options_buttons.png)
