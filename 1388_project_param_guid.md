...
![Pepparkakor](img/437_jeremy_pepparkakor_cropped_380x290.jpg)
...
on [reporting on project parameter definitions – need GUIDs](http://forums.autodesk.com/t5/revit-api/reporting-on-project-parameter-definitions-need-guids/m-p/5947552) was resolved back then and never published by The Building Coder, in spite of best intentions of doing so.
...
![Project parameter GUID reporter](img/project_parameter_guid_01.png)
> Pasting into a spreadsheet results in this:
![Project parameter GUID report](img/project_parameter_guid_02.png)
...
![Parameter Properties](img/project_parameter_guid_03.png)
...
![Shared project parameter GUID](img/project_parameter_guid_04.jpg)
