...
#### Inside the Factory Sessions Live AMA
...
The idea is to take questions from the broad Revit community about Revit – a "stump the chumps" session.
...
![Inside the factory](img/inside_the_factory.png "Inside the factory")