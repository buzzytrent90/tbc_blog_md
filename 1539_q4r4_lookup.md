...
![Elasticsearch](img/icon-elasticsearch-bb.png)
...
- [Hitchhiker's Guide to Python – HTML scraping](http://docs.python-guide.org/en/latest/scenarios/scrape/)
...
The `Close` method must not be called – it successfully closes non-active documents and fails to get information about them.
