...
![SLOG file](img/slog_file_first_entry_for_the_day.jpg "SLOG file")
...
While you may not have any collaboration projects on Autodesk Docs / BIM360 today it’s advisable to account for it in theory at least – otherwise you’ll have large gaps in the data with no plan on how to fill them in.
...
the wish list item \*CF-2162 – API: DocumentChanging or ElementsDeleting event before element is deleted -- 10292440\*.
#### How to Favicon
...
recommended in the extensive [analysis by *iconmap*](https://iconmap.io/blog) based
...
![Palindrome date](img/20211202.png "Palindrome date")
