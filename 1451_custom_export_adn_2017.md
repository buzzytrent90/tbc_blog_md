...
[![Vancouver](https://c8.staticflickr.com/8/7554/27886955751_5bda328ae8_n.jpg)](https://www.flickr.com/photos/jeremytammik/albums/72157670359072255 "Vancouver")
...
![San Francisco cloud accelerator participants](img/2016-06-23_forge_accelerator_participants.jpg)
...
- [2017.0.0.10](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.10) – implemented jstree test file and verified proper tree population.
- [2017.0.0.11](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.11) – implemented test page in gh-pages and test link to it, split out test treedata into separate json file.
- [2017.0.0.12](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.12) – added json sample data from rme_advanced_sample_model.
- [2017.0.0.13](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.13) – removed duplicate root id -1.
- [2017.0.0.14](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.14) – store entire json graph for all systems on project info instead of separate subgraph on each individual system.
- [2017.0.0.15](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.15) – before integrating pull request #1 from @ChengZY.
- [2017.0.0.16](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.16) – integrated pull request #1 by @ChengZY.
- [2017.0.0.17](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.17) – split into three domain specific subgraphs and add full element description.
- [2017.0.0.18](https://github.com/jeremytammik/TraverseAllSystems/releases/tag/2017.0.0.18) – removed redundant top-level nodes and used hash code to generate unique jstree ids for top-level project, mechanical, electrical and piping nodes.
...
![Custom JSON exporter exception](img/custom_exporter_adn_mesh_json_crash_3.png)
...
Sorry, I cannot explore this further myself, so I raised the issue ***REVIT-94525** CustomExporter throws ExternalApplicationException after call to Finish* with the development team for them to analyse in more depth.
...
For instance, they are implementing their own events using delegates, dictionaries, abstract base classes, timers, separate threads, called co-routines in Unity – impressive stuff for just a couple of days of coding.
