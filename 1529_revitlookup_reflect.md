...
his [pull request #25 – old bug fixes and improvements of the new approach ](https://github.com/jeremytammik/RevitLookup/pull/25).
...
> Probably yesterday I was a bit emotional. Because my first opinion was – what the hell?
...
I've found where exactly in the code – `GeometryInstance` is cast to `Element`, but is not in fact derived from it.
...
Before:
![Before](img/revitlookup_vc_1a.png)
After:
![After](img/revitlookup_vc_1b.png)
#### 2. Show Enum Values
Changed behaviour to show enum values.
Before:
![Before](img/revitlookup_vc_2a.png)
After:
![After](img/revitlookup_vc_2b.png)
...
Before:
![Before](img/revitlookup_vc_3a.png)
After:
![After](img/revitlookup_vc_3b.png)
#### 4. Remove Duplicate `get_` Property Getter Method
...
Before:
![Before](img/revitlookup_vc_4a.png)
After:
![After](img/revitlookup_vc_4b.png)
#### 5. Fixed Fine DetailLevel Bug
...
Before:
![Before](img/revitlookup_vc_5a.png)
After:
![After](img/revitlookup_vc_5b.png)
#### 6. Visual Style of Separator
Changed visual style of the separator. Changed colour and shifted the title a bit.
Before:
![Before](img/revitlookup_vc_6a.png)
After:
![After](img/revitlookup_vc_6b.png)
...
> This is one thing that I recognised early on as a potential issue but is not a problem – unless there is something I'm completely missing here.
