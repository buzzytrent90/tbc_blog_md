...
optimization_date: '2025-12-11T11:24:36.697278'
...
post_number: '1903'
series: geometry
slug: whats_new_2022_1.4.1._floor_creation_api_replacements
...
- views
- walls
title: API Changes - 1.4.1. Floor creation API replacements
word_count: 75
---
...
- Autodesk.Revit.Creation.Document.NewFloor() (all overloads) → Floor.Create(Document document, IList profile, ElementId floorTypeId, ElementId levelId)
- Autodesk.Revit.Creation.Document.NewSlab() → Floor.Create(Document document, IList profile, ElementId floorTypeId, ElementId levelId, bool isStructural, Line slopeArrow, double slope)
- Autodesk.Revit.Creation.Document.NewFoundationSlab() → Floor.Create(Document document, IList profile, ElementId floorTypeId, ElementId levelId)
