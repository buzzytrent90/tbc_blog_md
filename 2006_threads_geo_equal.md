...
![Object.Equals et al](img/geo_obj_comparison.png "Object.Equals et al")
...
I also need to remove items from a List (List.Remove) which is sometimes hard if `Equals` and `GetHashCode` have not been overridden, since that method will use the default equality comparer.
