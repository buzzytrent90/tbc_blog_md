...
![George Moturi](img/george_moturi.png "George Moturi")
...
– maybe in earlier releases as well...
...
You say, *a newer version of the schema (adding more fields for example)*.
...
![Extensible storage schema erase error](img/estorage_erase_error.png "Extensible storage schema erase error")
...
Run `ListSchemas` – the schema is purged.
...
![Extensible storage schema conflict](img/estorage_schema_conflict.png "Extensible storage schema conflict")
