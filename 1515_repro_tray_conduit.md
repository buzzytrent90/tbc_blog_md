...
- [Question – how can I get the connectors of a `FamilyInstance`?](#3.1)
- [Answer – search online and samples](#3.2)
...
- [Watson wannabes: 4 open source projects for machine intelligence](http://www.infoworld.com/article/2858891/machine-learning/four-open-source-watson-machine-intelligence.html) – these projects are not as established as Watson, but they're open source and ready for work.
- [DARPA DeepDive](http://deepdive.stanford.edu/) – SQL and Python.
...
- [OpenCog](http://opencog.org/) – not much obvious immediate info on the web site.
...
![DeepDive](img/deep_dive_header_logo.png)
