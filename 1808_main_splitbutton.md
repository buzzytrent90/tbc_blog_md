...
![FindInserts](img/FindInserts.jpg)
...
![Wall shadow cutout](img/findinserts_wall_shadow_cutout.png)
For this API – `FindInserts`, here is
a [short demo recording](https://thebuildingcoder.typepad.com/files/findinserts_include_shadow.gif) –
i try to find the inserts on the joined wall but not the wall with the window:
![FindInserts demo](img/findinserts_include_shadow.gif)
...
#### Addendum – Meaning of includeSharedEmbeddedInserts
