...
- [Code 1 – Collect all family instances in document](#4.1)
- [Code 2 – Export families via `SaveAs`](#4.2)
- [Code 3 – Update Nested Family Definitions](#4.3)
- [Code 4 – Reload updated families](#4.4)
...
![Pet change task description](img/pet_change_3.jpg)

Pet change task description

![Pet change scenario rendering](img/pet_change_2.jpg)
...
- [Code 3 – Update Nested Family Definitions](#4.3)
- [Code 4 – Reload updated families](#4.4)
#### Code 1 – Collect all Family Instances in Document
...
#### Code 2 – Export Families via SaveAs
...
#### Code 3 – Update Nested Family Definitions
