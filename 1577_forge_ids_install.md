...
Who is supposed to install – and pay for – Revit?
...
For all such tasks, it may be well worthwhile thinking of shifting your app development platform to a much more accessible – and cheaper – environment, e.g., [Forge](https://autodesk-forge.github.io).
...
- [RvtFader](https://github.com/jeremytammik/RvtFader) – C# .NET Revit add-in to calculate and display signal attenuation using AVF
- [ForgeFader](https://github.com/jeremytammik/forgefader) – Forge viewer extension to calculate and display signal attenuation, cf.
...
#### Access Revit BIM Data and Element Ids from BIM360
...
#### Edit and Export Revit Properties in Forge
Philippe Leefsma demonstrates similar functionality in his [Configurator – Meta Properties](https://forge-rcdb.autodesk.io/configurator?id=59780eec17d671029c53420e) sample.
- Look at
...
- Bangalore, India – September 4-8
- Moscow, Russia – September 25-29
- Lyon, France – October 23-27
- Munich, Germany – date TBD
![Upcoming Forge accelerators](img/2017-08_upcoming_accelerators.png)
#### Updated Visual Studio Revit Add-In Wizard Installation
...
in his [issue #6 – install script alteration suggestion](https://github.com/jeremytammik/VisualStudioRevitAddinWizard/issues/6), and solved it
with [pull request #7 – path to profile folder](https://github.com/jeremytammik/VisualStudioRevitAddinWizard/pull/7).
He says:
...
#### Question on RevitLookup Installation
...
I located the folder with this path: Local disk (C:) – Program Data – Autodesk – Revit – Addins – 2017
...
#### RevitLookup Cannot Snoop Everything
Another little note on RevitLookup.
Prompted by the [issue #35 – RevitLookup doesn't snoop all members](https://github.com/jeremytammik/RevitLookup/issues/35),
I enhanced the documentation with the [caveat – RevitLookup cannot snoop everything](https://github.com/jeremytammik/RevitLookup#caveat--revitlookup-cannot-snoop-everything):
