...
![Autumn leaves](img/herbstbild.jpg)
...
![Pipe cylinder element sides](img/pipe_cylinder_element_sides.png)
...
![Pipe cylinder sides needed](img/pipe_cylinder_sides_needed.png)
...
![Positive sides of an elbow](img/pipe_cylinder_sides_positive.png)
