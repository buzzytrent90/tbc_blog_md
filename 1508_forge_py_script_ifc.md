...
:-)
![Paul Beatty](img/PaulBeatty.jpg)
...
- Authenticate an app – [forge_authenticate_app](#6)
- Query the file formats currently supported by the translation processes – [forge_formats](#7)
