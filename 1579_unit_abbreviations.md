...
slug: "unit_abbreviations"
author: "Jeremy Tammik"
tags: ['csharp', 'elements', 'parameters', 'revit-api', 'sheets', 'views']
source_file: "1579_unit_abbreviations.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1579_unit_abbreviations.html"
---
...
- [DisplayUnitType Enumeration](http://www.revitapidocs.com/2017/7d3d3306-a4c2-c577-0aeb-cca42d6cfd2f.htm) – The units and display format used to format numbers as strings. Also used for unit conversions.
- [UnitSymbolType Enumeration](http://www.revitapidocs.com/2017/1a6d5d01-d835-c419-c14a-4cd25f563ea0.htm) – The unit symbol displayed in the formatted string representation of a number to indicate the units of the value.
...
I'm not sure yet :-)
If the list of abbrevs is not complete – though I think it is – it should be easy to tweak it more to get there.
...
![SI base units](img/SI_base_unit.svg)