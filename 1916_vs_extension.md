...
![Nina for Revit](img/nina_for_revit.png "Nina for Revit")
...
– The effects of a hotter planet are visible around the world (you may need to subscribe to read the full article).
...
I prefer to look at the positive side of things, and what I ***do*** want to do.
