...
After mentioning a very simple example of using the Revit Structural analytical model to
[find connected structural elements](http://thebuildingcoder.typepad.com/blog/2011/01/finding-connected-structural-elements.html) two days ago,
...
[exploiting the Autodesk Robot Structural Analysis Professional API for structural optimisation](http://images.autodesk.com/adsk/files/autodeskrobot_structuralanalysisprofessional_whitepaper_final.pdf).
...
- Overview of Robot Structural Analysis Professional API- Introduction to Optimization- Analysis Automation and Optimization- Implementation and Case Studies- Summary- About the Authors