...
![Memory append overwrite](img/pyrevit_mappendoverwrite.png)
Memory read:
![Memory read](img/pyrevit_mread.png)
Other selection memory utilities:
![Other selection memory utilities](img/pyrevit_othermemory.png)
...
![Match graphic overrides](img/pyrevit_matchgraphicoverrides.png)
\*\*\*pyRevit\*\*\* provides many other powerful scripts, and most of them are really useful in a production environment.
![Analyse and modify pallete](img/pyrevit_analysisandmodifypallete.png)
Project palette:
![Project palette](img/pyrevit_projectpallete.png)
Desktop palette:
![Desktop pallette](img/pyrevit_desktoppallete.png)
...
![pyRevit folder](img/pyrevit_pyrevitfolder.png)
...
run them.
![RevitPythonShell console](img/pyrevit_revitpythonshellconsole.png)
...
![pyRevit _init_ script](img/pyrevit_initscript.png)
...
#### pyRevit Overview, Installation and Tutorial Video
