...
The [Revit API expert panel](#1) session took place directly after the
[keynote sessions](http://thebuildingcoder.typepad.com/blog/2014/12/autodesk-university-keynote.html) and lunch yesterday.

Before getting to that, let me mention that for the first time after half a decade or more of working closely together in the ADN DevTech AEC team, I was finally able to shake hands with my ex-colleague
[Ye Xiong Jin](http://blog.csdn.net/joexiongjin/article/details/36218457) (叶雄进),
better know to us as
[Joe Ye](http://adndevblog.typepad.com/aec/joe-ye.html).

![Joe Ye and Jeremy at AU](img/joe_ye_au_2014.jpeg)

Joe is now independently active with his own company [www.gisbim.com](http://www.glsbim.com) or *Mount of Olives*, pronounced *Gan Lan Shan* (橄榄山).
...
So, now, here are notes from the AU session
[SD5156 – Revit API Expert Panel – Open House on the Factory Floor](https://events.au.autodesk.com/connect/sessionDetail.ww?SESSION_ID=5156):
...
- Adam Nagy, ADN
- Andrzej Trelinski, Revit Development
- Angel Velez, Revit Development
- Jeremy Tammik, ADN
- Mikako Harada, ADN
- Miroslav Schonauer, Autodesk Consulting
- Saikat Bhattacharya, Autodesk Consulting
...
**Arnošt** adds: It is not accurate to claim that you can access visual material images via the custom export. The image available in the MaterialNode is an image of the material tile, intended to be used in the Material dialogue. Even if it is available at all, it can hardly be used to display the material as rendered.
