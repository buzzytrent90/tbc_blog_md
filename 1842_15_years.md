...
tags: ['elements', 'filtering', 'parameters', 'revit-api', 'sheets']
source_file: "1842_15_years.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1842_15_years.html"
---
...
* Mikako Harada: Happy 15-year anniversary with Autodesk!! A big milestone!Jeremy joined Autodesk as a member of Autodesk Consultant and shortly after he moved to our team. At that time, Revit API was still toddler. We were pushing API both directions: internally to push Revit toward API first, and externally evangelize with very little API. Jeremy was instrumental for that task, especially for external customer facing side. At that time, many of us were not sure how much we can form for community based support. Jeremy made a big success with his Building Coder blog. He got a nickname “King of Revit API”. Some developer said Jeremy is posting like “machinegun.” Now Revit API community is the most active one among Autodesk product APIs.Many thanks for your contribution, Jeremy~ Great to have you in our team!
* Chandra Shekar G: Congratulations Jeremy on completion of big milestone!!!
* Virupaksha Aithal K M: Thank you, Jeremy, – “King of Revit” ☺ ... Good one.
* Jim Quanci: And Jeremy "really" has over 20 years at Autodesk being a "double dipper"... I fondly remember meeting Jeremy for the first time in the early '90s when he gave our very first (in the world) ObjectARX class.You might say Jeremy has over 25 years given he was still in the community working for an ADN member when he left Autodesk for a bit.Autodesk (and our whole dev community) was/is so lucky to have him.Well done Jeremy!\*What a long strange trip it's been\* – The Grateful Dead
...
* Xiao Dong Liang: Indeed, Jeremy’s blog and contributions on forum tremendously extends the knowledgebase of API help document. It is first place where many customers (and I) will check when they have specific questions and google always ranks the articles topmost if searching Revit API questions. And the blog is not just an article, but also a sharing with the journey and interesting stories ☺Happy anniversary Jeremy! Well deserved with the title “King of Revit API” ! ☺
* Jaime Rosales Duque: Happy Anniversary Jeremy!!I remember when I was back in my Startup days, your content and support helped me tremendously advance with the development of the Glue Plugins in Revit and I will always be grateful for that help you provided.
  It is always nice to see how people get excited to know you will be present at the events we host, and you will be able to share your input live with the Revit API knowledge only you have.A couple of pictures from my phone to commemorate the celebration ☺
  ![15 year stint at Autodesk](img/15year_jaime_1.jpg "15 year stint at Autodesk")

  ![15 year stint at Autodesk](img/15year_jaime_2.jpg "15 year stint at Autodesk")

  ![15 year stint at Autodesk](img/15year_jaime_3.jpg "15 year stint at Autodesk")
* Naveen Kumar T: Happy Anniversary Jeremy!!
* Zhong (John) Wu: Great moment! Congratulations Jeremy, I love what Jim mentioned, it’s great and so lucky to have you within the Autodesk Developer Community ☺Including one of mine to celebrate the great moment:
  ![15 year stint at Autodesk](img/15year_zhong.jpg "15 year stint at Autodesk")
...
* Kean Walmsley: Happy belated anniversary, Jeremy! ☺Thanks for all you’ve done for Autodesk and our developer community, over the years.May the 4th be with you,
* Peter Schlipf: Congratulations Jeremy !
  ...
  ![15 year stint at Autodesk](img/15year_peter_1.jpg "15 year stint at Autodesk")
  And from the Munich Accelerator:
  ![15 year stint at Autodesk](img/15year_peter_2.jpg "15 year stint at Autodesk")
...
* Michael Beale: Jeremy - Congratulations and Happy 15th Anniversary!
  ...
  Cheers mate
  ![15 year stint at Autodesk](img/15year_michael_1.jpg "15 year stint at Autodesk")

  ![15 year stint at Autodesk](img/15year_michael_2.jpg "15 year stint at Autodesk")
* Eason Kang: Congratulations Jeremy!!!Indeed, Jeremy's contributions to the Revit API community help a lot of our customers (included me). Without you, the Revit API community won't grow so big and quickly.You're the abecedarian teacher of Revit API to me! :)
...
\*\*Question:\*\* I have a `List` with elements that always are circumscribed to a quad.
...
![Outer loop around points](img/outer_loop_of_points_1.png "Outer loop around points")
...
![Outer loop around points](img/outer_loop_of_points_2.png "Outer loop around points")
