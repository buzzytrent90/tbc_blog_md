...
- [Back to the ants – project summary](#4)
- [Q & A](#5)
- [Two different energy model types](#6)
- [Addendum – Advances in Architectural Geometry 2016](#7)
...
The two different options are selected by settings in the `EnergyAnalysisDetailModelOptions` to base calculations either on spatial elements – i.e., rooms and spaces, assuming vertical boundaries – or bounded by actual building elements – i.e., floors, walls and ceilings, which may be arbitrarily shaped.
