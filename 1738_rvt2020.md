...
tags: ['elements', 'levels', 'parameters', 'references', 'revit-api', 'sheets', 'vbnet', 'views', 'windows']
source_file: "1738_rvt2020.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1738_rvt2020.html"
---
...
![RvtSamples loaded all Revit 2020 external commands](img/rvtsamples2020.png)
...
Forge sessions:
- 2019-02-26 – [DevDays Keynotes](https://youtu.be/XP9Fb9R-laM)
- 2019-02-27 – [Forge API update](https://youtu.be/rqaO1yx1g94)
- 2019-02-28 – [Design Automation API](https://youtu.be/G-pP37GQycQ)
- 2019-03-05 – [BIM 360 product and API update](https://youtu.be/CGEMLDVf9Oc)
Desktop product sessions on the ADN page:
- 2019-03-06 – [Inventor, Vault and Fusion API update](https://adn.autodesk.io/index.php?r=custom_pages%2Fview&id=143)
- 2019-03-07 – [Revit API, Civil 3D & InfraWorks updates](https://adn.autodesk.io/index.php?r=custom_pages%2Fview&id=143)
- 2019-03-12 – [The next release of AutoCAD APIs](https://adn.autodesk.io/index.php?r=custom_pages%2Fview&id=143)
...
- 2019-01-28 – [Meet the Expert: Revit 2020](https://www.dropbox.com/s/aqqp5mc45ktdt73/Meet_the_Expert_Revit_2020.zip?dl=0)
- 2019-03-07 – [DevDays Online 2019: Autodesk Revit API, Civil 3D and InfraWorks updates](https://www.dropbox.com/s/5i5txlwzuff64v8/DevDays%202019-Revit-Civil3D-Inforworks.zip?dl=0)
...
![Revit 2020 rejects Windows 8.1](img/revit_2020_rejects_win_8_1.png)
...
C:\...\Samples\RvtSamples\CS\bin\Debug\RvtSamples.dll
