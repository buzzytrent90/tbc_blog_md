...
Here is an illuminating explanation by Arnošt Löbel and Martin Schmid on some [Revit API development trends](#3) that have already been underway for a couple of releases.
...
[Adam Nagy's tweets](https://twitter.com/adamthenagy) in
the past few days, I am at a team meeting with my European ADN colleagues:

![Team meeting in Brittany](file:////j/photo/jeremy/2015/2015-03-31_bretagne/20150331_103750_silhouettes_cropped.jpg)

We are convening in
[Brittany](https://en.wikipedia.org/wiki/Brittany),
home of our manager Cyrille Fauvel.

![Flag of Brittany, named Gwenn-ha-du](img/Flag_of_Brittany_Gwenn_ha_du_218.png)

The hotel has a nice view of the wild Atlantic Ocean coast:

![View of the coast and waves](file:////j/photo/jeremy/2015/2015-03-31_bretagne/20150330_172153_view_cropped.jpg)

Here we are at lunch, except for Adam, our social media expert photographer:

![EMEA ADN team at lunch](file:////j/photo/jeremy/2015/2015-03-31_bretagne/20150331_123621_lunch_cropped.jpg)

Unfortunately, I have to leave again today, all too soon, to get back home for the Easter holiday.

Luckily, I was able to experience the landscape at least a little bit after our all-day meeting yesterday by taking a nice walk from our meeting
[Hôtel Le Château de Sable](http://www.lechateaudesablehotel.fr) –
'Kastell-Treaz' in Breton – to the [O'Porsmeur restaurant](https://www.facebook.com/porsmeur):

![Walk from Hôtel Le Château de Sable to O'Porsmeur restaurant](img/porspoder_walk_map.png)

Better still, I was not forced to walk on the roads, but could follow the GR34 hiking path
[randonnée en Bretagne sur le GR34](http://www.wmaker.net/opcc/gr34):
![Randonnée en Bretagne sur le GR34](img/GR_34_bretagne.jpeg)

My section from Portsall via Porspoder to Lanildut forms part of its
[fifth stage from l'Aber-Benoit to Faou](http://www.wmaker.net/opcc/gr34/Etape-5-de-l-Aber-Benoit-au-Faou_r6.html).
...
Such a sentiment prompted this
[comment](http://thebuildingcoder.typepad.com/blog/2015/03/calculating-gross-and-net-wall-areas.html?cid=6a00e553e16897883301b8d0f58dec970c#comment-6a00e553e16897883301b8d0f58dec970c) by
Dave on
...
**Answer:**
Thank you for your comments, which I will reinterpret as constructive questions that raise interesting issues that help illustrate some API design principles and future trends important and worthwhile understanding.
...
**Martin:**
Why did we modify the Revit API to require a pipe system type when creating a pipe? – To be consistent with the UI.
