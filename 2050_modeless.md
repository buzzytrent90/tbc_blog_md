...
→ API validation – no transactions from outside threads
...
Curious to hear what you would expect here – PDF encoding isn't quick in my experience.
\*\*Response:\*\*
