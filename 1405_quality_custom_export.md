...
[![Skitour Albristhore](https://farm2.staticflickr.com/1624/25056609062_66b1e71786_n.jpg)](https://www.flickr.com/photos/jeremytammik/albums/72157664235570149 "Skitour Albristhore")
Here are some topics to get going again:
- [Reorg and Octo](#2)
- [The Future of Making Things, Iot, Forge and more](#3)
- [Forge and the DevCon in SF](#4)
- [T4 – Top Twelve TED Topics](#5)
...
![QR Code image used in a Label Schedule](img/fm_ScheduleQrcode-1-1024x527.png)
Here is a screen snapshot of the scanned QR code on a smartphone:
![QR Code scanned on mobile device](img/fm_qrc-768x1365.png)
