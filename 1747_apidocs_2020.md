...
tags: ['elements', 'references', 'revit-api', 'rooms', 'sheets', 'views', 'walls']
source_file: "1747_apidocs_2020.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1747_apidocs_2020.html"
---
...
>
> - 2015 removed from navbar – the old docs are still available through the `/2015` URL
...
![RevitApiDocs 2020](img/revitapidocs2020.png)
...
![Room boundary segments](img/room_boundary_segments.png)
...
![Width and height of CurveLoop](img/curveloop_width_height.png)
...
future reference.
To make it more generic, I implemented an extension method `ExpandToContain( IEnumerable )` on the bounding box and use it to calculate the bounding box of a curve loop like this:
```csharp
///
...
![AI and Architecture](img/ai_and_architecture.png)