...
When I click the face of a family instance, it still creates the filled region – but instead of creating it over the face of the family instance, it creates the instance at the project origin of the document.
...
![Roof face and filled region](img/xform_inst_1.png "Roof face and filled region")
However, when I click this electrical equipment face...
![Electrical equipment face](img/xform_inst_2.png "Electrical equipment face")
It creates the filled region over at the project origin:
![Filled region at project origin](img/xform_inst_3.png "Filled region at project origin")
...
IList faceEdges = moduleFace.GetEdgesAsCurveLoops();
