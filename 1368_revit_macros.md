...
- [Full moon fire](#3)
- [Revit 2016 R2](#4)
- Session #44 – [Connecting the Desktop and the Cloud](#5) – Cloud-based universal component and asset usage analysis, visualisation and reporting
- Session #130 – [The Building Coder Chatroom](#6) – All you ever wanted to ask about Revit API, The Building Coder, and all other non-UI Revit topics
- Session #161 – [Getting Started with Revit Macros](#7)
- [What Are Macros?](#11)
...
[![Autumn Walk over Schauenburg](https://farm1.staticflickr.com/781/22512038985_e8f12d3c78_n.jpg)](https://www.flickr.com/photos/jeremytammik/albums/72157660327361056 "Autumn Walk over Schauenburg")
#### Full Moon Fire
...
[![Full Moon Fire](https://farm1.staticflickr.com/710/22523540901_e132b9d87a_n.jpg)](https://www.flickr.com/photos/jeremytammik/albums/72157660328082446 "Full Moon Fire")
...
class [CM2116 – Revit Customization for Mere Mortals: Save Time (and Your Sanity) with Revit Macros](http://au.autodesk.com/au-online/classes-on-demand/class-catalog/2013/revit-for-architects/cm2116) provide
...
He is presenting a similar class this year as well, [IT11135-L – Getting Started with Revit Macros](https://events.au.autodesk.com/connect/search.ww#loadSearch-searchPhrase=kilkelly&searchType=session&tc=1&sortBy=&i(11080)=&i(11700)=):
...
![Revit SDK](img/revit_macros_01.png)
...
![Manage tab](img/revit_macros_02.png)
...
![Macro manager](img/revit_macros_03.png)
...
![Create new module](img/revit_macros_04.png)
...
![Create new macro](img/revit_macros_05.png)
#### 4. Write the Macro
...
![Macro source code](img/revit_macros_06.png)
```csharp
...
![Build the macro](img/revit_macros_07.png)
...
![Error list](img/revit_macros_08.png)
...
![Run macro](img/revit_macros_09.png)
...
![Macro message box](img/revit_macros_10.png)
...
![Code to report project path name](img/revit_macros_11.png)
...
![Converting language](img/revit_macros_12.png)
...
![Revit API help file RevitAPI.chm](img/revit_macros_13.png)
...
![Systems.Diagnostics namespace](img/revit_macros_14.png)
...
![Step through code](img/revit_macros_15.png)
...
![Break point](img/revit_macros_16.png)
...
![C# comment](img/revit_macros_17.png)
...
![Real-world macro](img/revit_macros_18.png)
#### Next Steps
