...
![Materials and Visual API](img/go_visual_api_1.png "Materials and Visual API")
shows as being an "Old Style" rendering Asset once it has been imported into the document:
![Materials and Visual API](img/go_visual_api_2.png "Materials and Visual API")
Yet, Assets using the PrismOpaqueSchema show as "New Style" Asset types (as would be expected for the above):
![Materials and Visual API](img/go_visual_api_3.png "Materials and Visual API")

![Materials and Visual API](img/go_visual_api_4.png "Materials and Visual API")
Just another glitch?
...
\*\*Answer:\*\* `FamilySymbol` should be fine in your case – it is derived from `ElementType`.
