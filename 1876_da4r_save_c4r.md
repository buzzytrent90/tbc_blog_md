...
- [`IOpenFromCloudCallback` and the `DefaultOpenFromCloudCallback` class](https://thebuildingcoder.typepad.com/blog/2019/05/precast-api-and-cloud-open-callback.html#3) – using the Revit 2019 API to detach a model from BIM360
...
![Transparent](img/transparent_tiny_house.jpg "Transparent")