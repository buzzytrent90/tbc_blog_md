...
AutoJoinElements forces the elements in the Revit document to automatically join to their neighbours where appropriate.
...
If I run the Revit API introduction external command Lab2\_0\_CreateLittleHouse, which creates a little house consisting of four walls with a door and some windows, a floor, a roof, and a room, the end result after the command terminates looks like this:

![Little house with unjoined walls](img/little_house_unjoined.png)
...
![Little house with joined walls](img/little_house_joined.png)
