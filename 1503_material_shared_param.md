...
- [Cornelius story – cured by natural remedies](#8)
Before getting to all that, let me mention that I am now busy at the Munich DevDays conference.
![Munich DevDay](img/2016-12-05_devday_munich_305_500x225.jpg)
...
- [\*\*SD20891\*\* – Revit API Expert Roundtable – Open House on the Factory Floor](http://au.autodesk.com/au-online/classes-on-demand/class-catalog/2016/revit/sd20891)
- [\*\*SD20908\*\* – Connect Desktop and Cloud – Free Your BIM Data!](http://au.autodesk.com/au-online/classes-on-demand/class-catalog/2016/revit/sd20908)
...
[release 2017.0.0.7](https://github.com/jeremytammik/AdnRevitApiLabsXtra/releases/tag/2017.0.0.7).
#### Linking `Material` Elements to External Database Entries
...
In other words, he would like to add specific IDs (parameters) to materials that he could write out to a database. He mentions the analogy with shared parameters – it seems he would like to create custom shared parameters and add them to materials.
...
#### Attaching a Shared Parameter to `Material` Elements
...
- [compare 2017.0.0.5...2017.0.0.6](https://github.com/jeremytammik/AdnRevitApiLabsXtra/compare/2017.0.0.5...2017.0.0.6) – compare the original code binding to the `Doors` category and the modifications made to switch to `Materials` instead.
- [compare 2017.0.0.6...2017.0.0.7](https://github.com/jeremytammik/AdnRevitApiLabsXtra/compare/2017.0.0.6...2017.0.0.7) – compare the code binding to the `Materials` category and the code after switching back to `Doors`.
...
son [Cornelius story – cured by natural remedies](http://on-lyme.org/en/sufferers/lyme-stories/item/241-cornelius-story-cured-by-natural-remedies) on suffering and recovering from Lyme chronic disease.
![Iris](img/cornelius_iris.jpg)