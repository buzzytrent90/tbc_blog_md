...
content_type: qa
optimization_date: '2025-12-11T11:44:13.453476'
original_url: https://thebuildingcoder.typepad.com/blog/0154_rename_group.html
post_number: '0154'
reading_time_minutes: 2
series: general
slug: rename_group
source_file: 0154_rename_group.htm
tags:
- csharp
- elements
- family
...
I have very busy this last week answering cases and preparing training material.
...
This group issue is of great importance since I am working on creating walls with studs and beams, so called structural framing.
...
Good when you are specifying products.

**Answer:**
We already discussed the
[creation of a group](http://thebuildingcoder.typepad.com/blog/2009/02/creating-a-group-and-how-to-fish.html).
...
There is no real difference between these two properties, even though one can be changed and the other cannot.
They return the same value and are probably pointing to the same data field somewhere.

The split into Group and GroupType classes was probably made to reuse the typical Revit family structure, similar to the relationship between Wall and WallType or family instance and family symbol.
