...
![Cable tray bend radius](img/cabletraybend01.png "Cable tray bend radius")

![Cable tray bend radius](img/cabletraybend02.png "Cable tray bend radius")
\*\*Answer:\*\*
...
![Cable tray bend radius](img/cabletraybend03.png "Cable tray bend radius")
\*\*Answer:\*\*
Yes, exactly.
...
if (connectors.Size == 2)
{
  ...
  var castConnectors = connectors.Cast();
  List connectorList = castConnectors.ToList();
  // get first point
...
![Cable tray bend radius](img/cabletraybend04.png "Cable tray bend radius")
And what about Cable Tray Fittings which are vertical or visible in section like this?
![Cable tray bend radius](img/cabletraybend05.png "Cable tray bend radius")
\*\*Answer:\*\*
...
```
  ElementId id = uidoc.Selection.PickObject(
...
![Cable tray bend radius](img/cabletraybend06.gif "Cable tray bend radius")
\*\*Response:\*\*
YouHou!!! It works!!
...
![Cable tray bend radius](img/cabletraybend07.png "Cable tray bend radius")

![Cable tray bend radius](img/cabletraybend08.png "Cable tray bend radius")

![Cable tray bend radius](img/cabletraybend09.png "Cable tray bend radius")
...
![Cable tray bend radius](img/cabletraybend10.png "Cable tray bend radius")
...
![Cable tray bend radius](img/cabletraybend11.png "Cable tray bend radius")
...
![Tee identification](img/tee_identification_1.png "Tee identification")
...
I thought the angle property could help me here, but no luck – in the families I'm looking at, they are all 0.
...
![Tee identification](img/tee_identification_2.png "Tee identification")
Here is the code for the function:

```
  public static Element AnalyzeTee2(
    Element element,
    Document doc)
  {
    ...
    List tpieceConnectors = getConnectors(element);
