...
> - AI-Powered Coding Assistance – Generate and refine Revit code effortlessly using natural language prompts.
- Edit & Execute Code Seamlessly – Modify and run scripts directly in Revit to automate your tasks.
- One-Click Execution & Results – Instantly run scripts and see results with just a click.
- Full Control Over Execution – Choose exactly what your script runs in your model.
- Customizable Workflows – Save and reuse automation scripts tailored to your project.
#### Revit MCP Connector
...
check out [Cursor – The AI Code Editor](https://www.cursor.com/)),
...
![Evolving development stack 2025](img/full_stack_develop_2025.png "Evolving development stack 2025")
I love the caption explaining the source of this chart data: 'I made this up. There is no data.''
#### Jupyter Interactive Graphs
