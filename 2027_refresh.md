...
foreach (SpotDimension item in spotdimensionList)
{
  ...
  doc.Regenerate();
  uidoc.Selection.SetElementIds(new List ( item. id ));
}
...
![Select to refresh graphics](img/select_to_refresh.png "Select to refresh graphics")
...
void SetStartingView ()
{
  ...
  var myView = feCollector
    .OfClass(typeof(Autodesk.Revit.DB.View)).Cast()
    .Where(v
...
we have been seeing more and more of – and suffering the consequences of – in real life in recent years.
#### Last Year Was Hot
...
![Earth average temperature timeline](img/xkcd_earth_temperature_timeline.png "Earth average temperature timeline")
...
![PV panel price trend](img/2024_pv_panel_price_trend.png "PV panel price trend")