...
tags: ['family', 'filtering', 'revit-api', 'schedules', 'sheets', 'views']
source_file: "1502_bim360docs.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1502_bim360docs.html"
---
...
If you are interested in more API related BIM 360 information, please refer to Mikako's blog, [The Field of View – BIM 360 API & cloud-based technologies for the AEC industry](https://fieldofviewblog.wordpress.com).
...
– on [OAuth](http://autode.sk/2gRl1hP)
...
– on the [Model Derivative API](http://autode.sk/2gRkv3a) that enables users to represent and share their designs in different formats and extract metadata.
- [Introduction to Viewer](http://adndevblog.typepad.com/cloud_and_mobile/2016/09/introduction-to-viewer-api.html)
– the [Viewer](http://autode.sk/2gRfJCX), formerly part of the 'View and Data API', is a WebGL-based JavaScript library for 3D and 2D model rendering of CAD models from seed files, e.g., [AutoCAD](http://www.autodesk.com/products/autocad/overview), [Fusion 360](http://www.autodesk.com/products/fusion-360/overview), [Revit](http://www.autodesk.com/products/revit-family/overview) and many other formats.
...
– the [Design Automation API](http://autode.sk/2gRhakS), formerly known as 'AutoCAD I/O', enables running scripts on native CAD design files such as `DWG`,
...
– [BIM360](http://autode.sk/2gRdiA9) enables apps to integrate with BIM360 to extend its capabilities in the construction ecosystem.
