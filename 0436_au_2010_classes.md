...
Kean's post on
[AU 2010 classes](http://through-the-interface.typepad.com/through_the_interface/2010/08/au-2010-classes.html) yesterday
...
[AU website](http://au.autodesk.com):

![AU 2010 classes](img/au_2010_classes.jpg)

My classes are the following:

- **CP228-2**: [Optimal Use of New Autodesk Revit 2011 Programming Features](#1), a lecture on Revit 2011 API features in general, on Tuesday 2010-11-30 14:00-15:00.- **CP234-2**: [Exactly What You Want and Faster: Autodesk Revit 2011 Programming Optimization](#2), a lecture on Revit 2011 API optimisation, including a number of filtering techniques and benchmarks, on Tuesday 2010-11-30 17:00-18:00.- **CP316-3U**: [All Systems Go in Autodesk Revit MEP Programming](#3), an 'Unconference' together with Martin Schmid on the Revit MEP API on Wednesday 2010-12-01 at 8:00-9:00 (this class was previously numbered CP333-4U and scheduled for Wednesday 2010-12-01 at 16:30-17:30).

#### Optimal Use of New Autodesk Revit 2011 Programming Features

This class teaches everything you need to know
...
This class goes one step beyond the optimal use of
...
This class discusses the possibilities and optimal
...
As an 'Unconference', this session is actually not a lecture or class at all, but rather a discussion group co-led with Martin Schmid to share and discuss Revit MEP application development experiences among peers.
...
By the time you read this, I will have left on yet another vacation, this time northwards, to go sailing along the coast of Norway and Sweden, from Stavanger to Göteborg.
