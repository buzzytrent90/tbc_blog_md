...
Panel members:
- Boris Shafiro – Revit Software Development Manager
...
[API – create a calculated value field in schedule](https://forums.autodesk.com/t5/revit-ideas/api-create-a-calculated-value-field-in-schedule/idi-p/8065079).
...
Q Collection classes are often `IEnumerable`, not `IEnumerable`?
...
![Eclectic shorthand](img/stenography_eclectic_shorthand_by_cross.png "Eclectic shorthand")
#### Addendum – Full Recording
