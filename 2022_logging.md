...
![User history](img/user_history.jpg "User history")
...
![BIM dashboard](img/bim_dashboard2.png "BIM dashboard")
...
![BIM-GPT NL query prompt processing](img/bim_gpt_prompt_manager_nl_processing.png "BIM-GPT NL query prompt processing")
#### AEC Greenwashing
