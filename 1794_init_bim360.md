...
tags: ['elements', 'parameters', 'references', 'revit-api', 'selection', 'sheets', 'transactions', 'views']
source_file: "1794_init_bim360.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1794_init_bim360.html"
---
...
the ADN case 14906646 [old topic brought back – changing link paths to cloud paths](https://forums.autodesk.com/t5/revit-api-forum/old-topic-brought-back-changing-link-paths-to-cloud-paths/m-p/8476438).
...
\*\*Question:\*\* I would like to save a local RVT to my BIM360 account – with Design Collaboration service activated – using the Revit 2020 API, but Revit always throws an exception saying that I do not have the required access rights.
...
![BIM360 Docs linking](img/bim360_docs_xrefs.jpg)
...
[on GitHub](https://github.com/ripienaar/free-for-dev) –
...
by [Kurzgesagt – in a nutshell](https://www.youtube.com/channel/UCsXVk37bltHxD1rDPwtNM8Q):
