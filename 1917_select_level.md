...
I discovered that some levels can't be retrieved through the `get_Parameter` method – they only appear in the `LevelId` and `ReferenceLevel` properties.
...
![Spirit level](img/spiritlevel.jpg "Spirit level")
