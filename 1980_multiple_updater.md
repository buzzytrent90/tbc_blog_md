...
Last week saw a bunch of roadmap discussions looking at future ideas and directions of different areas of Revit and Dynamo in *Ask me Anything* or AmA format, and now the event recordings are provided for your illumination and enjoyment:
...
– Community Conversation about the future of Autodesk AEC solutions, highlights from recent releases, including Revit and the AEC Collection, future of Autodesk AEC products, roadmap – Panelists: Harlan Brumm Autodesk Sr. Product Line Manager, Mike Engel Autodesk Sr. Product Manager, Bogdan Matei Autodesk Revit Product Manager, Matt Arsenault Autodesk Revit Product Manager, Sam Anderson of Twinmotion by Epic Games
- 2023-01-17 Computational Design and Automation (Dynamo) Roadmap AmA [Event recording](https://youtu.be/LfERZO3Fdzg)
– Public roadmap for Computational Design and Automation using Dynamo, future of Dynamo and Autodesk AEC solutions – Panelists: Lilli Smith Autodesk Sr. Product Manager, Sol Amour Autodesk Product Line Mgr., Jacob Small Autodesk Global Consulting Delivery
...
– Public roadmap for civil infrastructure products, future Civil 3D, InfraWorks, ReCap Pro, and the AEC Collection – Panelists: Dave Simeone Autodesk Sr. Product Manager Civil Products, Tim Yarris Autodesk Product Manager Civil 3D, Ramesh Sridharan Autodesk Product Manager ReCap + InfraWorks
- 2023-01-19 Structures Product Roadmap AmA [Event recording](https://youtu.be/JJ53a1EKFm8)
– Public roadmap for structural engineering products, Revit and the AEC Collection – Panelists: Pawel Piechnik Autodesk Director Product Management Structures Product Line, Dan Peticila Autodesk Product Manager
- 2023-01-19 MEP Product Roadmap AmA [Event recording](https://youtu.be/y3sHuWQqtYc)
– Product roadmap for MEP products, including Revit and the AEC Collection – Panelists: Martin Schmid Autodesk Product Line Manager
...
29. public void SetExecutionOrder(List updaters)
30. {
31. var count = updaters.Count;
33. for (var i = 0; i < count; i++)
34. {
35. var previous = updaters[i].GetUpdaterId();
36. var last = updaters[i + 1].GetUpdaterId();
38. UpdaterRegistry.SetExecutionOrder(previous, last);
39. }
40. }
...
29. public void SetExecutionOrder(List updaters)
30. {
31. var last = updaters[updaters.Count - 1];
32. var lastLoop = false;
33. var index = 0;
35. do
36. {
37. var current = updaters[index];
38. var next = updaters[index + 1];
39. lastLoop = next == last;
41. UpdaterRegistry.SetExecutionOrder(current.GetUpdaterId(), next.GetUpdaterId());
43. index++;
44. }
45. while (lastLoop == false);
46. }
...
- **Ownership**: WorksharingUtils.GetCheckoutStatus – Only a status of OwnedByOtherUser will cause an issue here
- **Update status**: WorksharingUtils.GetModelUpdatesStatus – The following two aspects will cause issues:
...
@RPTHOMAS108, your solution worked great – I coded up a simple function that'll I'll likely use on some other scripts.
Thanks for the help!
...
Instead of: log in as UserA — do something — log in as UserB — does it work?
![Worksharing](img/worksharing.png "Worksharing")
