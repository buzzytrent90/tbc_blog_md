...
– this is where Revit is currently creating the CEF cache folder –
...
The "tab" way – sharing the UDF and options – is more performant and uses less memory.
...
![WebView2Example](img/webview2example.gif "WebView2Example")
...
![Cast error](img/cast_geometryobject.png "Cast error")
...
![LandXML P tag](img/landxml_p_tag_1.png "LandXML P tag")![LandXML P tag](img/landxml_p_tag_2.png "LandXML P tag")
\*\*Answer:\*\* Yes.
