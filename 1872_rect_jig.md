...
- Onbox.Abstractions – Interfaces of all generic usage on the framework
- Onbox.Core – Core implementations for all generic services
- Onbox.Di – IOC container system
- Onbox.Mvc.Abstractions – Interfaces for interacting with Views
- Onbox.Mvc – Implementation of WPF MVC Views and Components
- Onbox.Mvc.Revit.Abstractions – Interfaces for interacting with Revit and Views
- Onbox.Mvc.Revit – Implementation of WPF MVC specific to Revit
- Onbox.Revit.Abstractions – Interfaces for interacting with Revit
- Onbox.Revit – Revit External Applications and Commands
- Onbox.Store – State management for Revit MVC / WPF
...
One is an industry talk (Lessons Learned in Three Years of Forge Dev – SD468705) that talks about our 3 years of Experience using Forge, the issues and problems we faced, and some tips and tricks for you do not waste so much time as we did try to solve them.
During the class we explain the benefits of using a loosely coupled architecture for building Revit applications.
The other one is a lab (The Cross-Platform Revit – SD468797-L).
...
![Onbox framework](img/ta_onbox_framework.jpg "Onbox framework")
...
![Jig](img/plan_view_rectangle_jig.gif "Jig")
...
![RevitApiDocs statistics](img/2020_revitapidocs_stats.png "RevitApiDocs statistics")
