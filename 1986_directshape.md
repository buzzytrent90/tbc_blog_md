...
We register each DirectShapeType definition name into client's database, and after changes are made – the name should remain the same.
...
![Many instances](img/many_instances.jpg "Many instances")
...
* [Export Family Instance to gbXML](http://thebuildingcoder.typepad.com/blog/2009/06/export-family-instance-to-gbxml.html)
* [Set Copy Local to False](http://thebuildingcoder.typepad.com/blog/2011/08/set-copy-local-to-false.html)
...
In the end, is better to not include it, makes your package smaller size – RevitAPI.dll alone is around ±28kb.
