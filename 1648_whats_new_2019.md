...
content_type: qa
optimization_date: '2025-12-11T11:44:16.456747'
original_url: https://thebuildingcoder.typepad.com/blog/1648_whats_new_2019.html
post_number: '1648'
reading_time_minutes: 9
series: whats_new
slug: whats_new_2019
source_file: 1648_whats_new_2019.md
tags:
- levels
- revit-api
- sheets
...
→ Yes, essentially the same; A360 might not use the latest version, though.
- Both have the same functionality. Is that correct?

→ The viewer is shared. Nothing else is comparable, though.
...
→ No, there is no API to manage Forge accounts.
...
→ Makes no sense; see above. Obviously, with Forge, you can implement anything you like yourself.
- My research shows it's not possible with BIM360 but is possible with Forge. Am I correct?

→ No; there is no concept of 'user' in 2-legged.
...
→ Please look at the [Forge pricing page](https://forge.autodesk.com/pricing).
...
→ Yes. Each new upload requires a new translation, so the cloud credit fee applies.
...
→ You don't need a BIM360 account to use Forge; it's independent.
...
→ As said, you can use Forge without BIM360 and BIM360 without Forge. You can also connect the two.
