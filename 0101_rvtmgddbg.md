...
A
[2009 version](http://download.autodesk.com/media/adn/RvtMgdDbg2009_0429_2008.zip)
is publicly available, and a
[2010 alpha version](http://adn.autodesk.com/adn/servlet/item?siteID=4814862&id=12264104&linkID=4901650)
...
The class
[DE111-3 – A Closer Look at the Revit Database with the Revit API](http://au.autodesk.com/?nd=class&session_id=2808)
...
![RvtMgdDbg main menu](img/de111_3_fig_5_RvtMgdDbg_main_menu.png)
...
![RvtMgdDbg main dialogue](img/de111_3_fig_6_RvtMgdDbg_dialogue.png)
...
Take a 'M\_Keynote Tag' (this is in a metric template), for example, there are three types defined in this family.
In the Snoop Db tool, you can locate this under Family tree node.
If you check the element named 'M\_Keynote Tag', you can find the member types under Symbols property.
...
![RvtMgdDbg component family](img/de111_3_fig_14_RvtMgdDbg_component_family.png)
...
To find out the family name, you can check the property of a wall type and look up its built-in parameter 'ALL\_MODEL\_FAMILY\_NAME':

![Wall system families and types](img/de111_3_fig_15_RvtMgdDbg_walls.png)
...
![Accessing types from the document object](img/de111_3_fig_16_RvtMgdDbg_doc_types.png)
...
![Accessing view-specific instances](img/de111_3_fig_17_RvtMgdDbg_view.png)
...
![Built-in parameters snoop tool](img/de111_3_fig_18_RvtMgdDbg_parameters.png)
