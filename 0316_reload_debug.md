...
I have two little updates on the article on John Morse's technique for
[dynamically loading a Revit add-in](http://thebuildingcoder.typepad.com/blog/2010/03/reload-an-addin-to-debug.html) without
having to restart Revit.

#### Debugging an Assembly Loaded from a Byte Array

First, the initial comments posted by Guy Robinson and John Morse on the topic led to some further insights, the gist of
...
[here](http://blogs.msdn.com/habibh/archive/2009/10/12/how-to-edit-code-when-debugging-a-64-bit-application.aspx).
...
Furthermore, Load(Bytes b) is just one method of loading assemblies, and you can also use LoadFrom in the right context and LoadFile.
...
Secondly, Daren Thomas, the author of the
...
[dynamically load plug-ins for debugging in RevitPythonShell](http://darenatwork.blogspot.com/2010/03/using-revitpythonshell-to-dynamically.html) as well.
