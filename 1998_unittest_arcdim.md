...
\*\*Question:\*\* I have a question about desktop APIs and SDKs – I'm more familiar with the cloud world, so apologies if this is a really dumb question.
...
![Arc dimensioning](img/dim_180_deg_arc_end_point_a0_r01.png "Arc dimensioning")
...
![Arc dimensioning](img/dim_two_180_deg_arcs_a01_r0.png "Arc dimensioning")
...
![Arc dimensioning](img/dim_two_180_deg_arcs_a01_r01.png "Arc dimensioning")
In summary, the tests above include:
- Arc 0, references 0 + 1 – both endpioints of one single arc
- Arc 0 + 1, reference 0 – the start points of two arcs
- Arc 0 + 1, references 0 + 1 – start and end point of both arcs, depending on the dimensioning orientation
