...
optimization_date: '2025-12-11T11:24:36.705608'
...
post_number: '1903'
series: geometry
slug: whats_new_2022_2.1.1._ceiling_creation
...
- views
- walls
title: API Changes - 2.1.1. Ceiling creation
word_count: 51
---
...
The new methods:
- Ceiling.Create(Document document, IList curveLoops, ElementId ceilingTypeId, ElementId level)
- Ceiling.Create(Document document, IList curveLoops, ElementId ceilingTypeId, ElementId levelId, Line slopeArrow, double slope)
