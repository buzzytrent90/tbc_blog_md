...
![Walls with varying thicknesses](img/createviaoffset_with_list_1.png)

Walls with varying thicknesses
...
![Walls with room separator](img/createviaoffset_with_list_2.png)

Walls with room separator

There have been no errors so far in situations like this:
![Walls with room separator offset](img/createviaoffset_with_list_3.png)

Walls with room separator offset
...
![Room separator boundary model curve loop](img/createviaoffset_with_list_room_separator_loop.png)
...
![Rectangular room with five walls](img/createviaoffset_with_list_wall_width_error_rvt.png)
...
Yes, I did test it with unpublished development code; however, we use `CreateViaOffset` in our add-in starting with 2019.1, methinks, and 100% certain in 2020 – it was fairly ok.
...
#### How to Determine Room Outline Including Surrounding Walls
