...
tags: ['csharp', 'levels', 'python', 'references', 'revit-api', 'sheets', 'vbnet', 'views', 'windows']
source_file: "2037_vb_2025.md"
original_url: "https://thebuildingcoder.typepad.com/blog/2037_vb_2025.html"
---
...
Create a node, check to see if that node contained the `` property, repeat until I found the correct one.
...
![VB 2025](img/vb_2025_2.png "VB 2025")
...
I also found a few repeated tags that were added to `` nodes by the upgrade tool whose removal helped greatly:
...
![Ferret multimodal LLM](img/ferret_mllm.png "Ferret multimodal LLM")
