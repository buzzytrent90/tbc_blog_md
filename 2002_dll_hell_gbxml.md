---
post_number: "2002"
title: "Dll Hell Gbxml"
slug: "dll_hell_gbxml"
author: "Jeremy Tammik"
tags: ['csharp', 'elements', 'geometry', 'levels', 'parameters', 'python', 'revit-api', 'sheets', 'transactions', 'views', 'walls', 'windows']
source_file: "2002_dll_hell_gbxml.md"
original_url: "https://thebuildingcoder.typepad.com/blog/2002_dll_hell_gbxml.html"
---
...
- [XmlNotepad](https://microsoft.github.io/XmlNotepad/) – to build familiarity with gbXML structure and mechanization
- [xgbxml](https://xgbxml.readthedocs.io/en/latest/what_is_xgbxml.html) – Python library for gbXML parsing and manipulation
![gbXML export](img/export_gbxml_settings.png "gbXML export")
...
![MongoDB export](img/li_mongodb_export_1.jpg "MongoDB export")
![MongoDB export](img/li_mongodb_export_2.jpg "MongoDB export")
![MongoDB export](img/li_mongodb_export_3.jpg "MongoDB export")
![MongoDB export](img/li_mongodb_export_4.jpg "MongoDB export")
![MongoDB export](img/li_mongodb_export_5.jpg "MongoDB export")
...
– recommendation: clone the repository
Many thanks, Eduardo!