...
![Elements and connectors not aligned](img/align_connectors_1.png "Elements and connectors not aligned")
My code is below.
...
![Align connectors](img/align_connectors_2.png "Align connectors")

![Align connectors](img/align_connectors_3.png "Align connectors")

![Align connectors](img/align_connectors_4.png "Align connectors")
Later:
...
–
Published online by [Erenow](https://erenow.net/common/sapiensbriefhistory/112.php)