...
![Sheet view title block geometry and text](img/pm_sheet_view_text_geom.jpg "Sheet view title block geometry and text")
...
ICollection lines = collector
.OfClass( typeof( FamilyInstance ) )
.OfCategory( BuiltInCategory.OST_Lines )
.ToElements();
ICollection texts = collector
.OfClass( typeof( FamilyInstance ) )
.OfCategory( BuiltInCategory.OST_TextNotes )
.ToElements();
ICollection filledRegions = collector
.OfClass( typeof( FamilyInstance ) )
...
![Sheet view title block geometry and text](img/pm_sheet_view_text_geom_2.jpg "Sheet view title block geometry and text")
...
![Snoop title block family](img/pm_sheet_view_text_geom_3.jpg "Snoop title block family")
...
![Element coordinates on sheet](img/element_coordinates_on_sheet.png "Element coordinates on sheet")
```vbnet
...
![Sheet as image](img/export_sheet_as_image_1.png "Sheet as image")

![Sheet as image](img/export_sheet_as_image_2.png "Sheet as image")
