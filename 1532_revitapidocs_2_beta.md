...
- Smarter nav-bar now also indicates if the doc was updated/removed across years, [for example the WallFoundation class](http://beta.revitapidocs.com/2016/29a6e040-a36e-2a0c-5339-c69aa7776301.htm) – note the coloured bars and tooltips under the year numbers.
...
- [Python Examples](http://beta.revitapidocs.com/2016/b0a5f22c-6951-c3af-cd29-1f28f574035d.htm) – adds Python snippets if one is found (beta).
...
- Copy code – [code examples](http://beta.revitapidocs.com/2016/29a6e040-a36e-2a0c-5339-c69aa7776301.htm) now have a `Copy` button which copies to the clipboard.
...
![Revit API Docs 2.0 Beta](img/revitapidocs_2_beta.png)