...
- [Download](#10)
- [RevDev Studios](#11)
- [Addendum – never catch all exceptions](#12)
...
[RevitLookup pull request #22 – Object inspection via `Reflection`](https://github.com/jeremytammik/RevitLookup/pull/22).
...
![RevitLookup using Reflection](img/revitlookup_reflect.png)
...
Andy's [RevitLookup pull request #22 – Object inspection via `Reflection`](https://github.com/jeremytammik/RevitLookup/pull/22):
#### Snoop / CollectorExts
...
submitting [pull request #23 – catching proper exceptions for reflection invocation](https://github.com/jeremytammik/RevitLookup/pull/23).
