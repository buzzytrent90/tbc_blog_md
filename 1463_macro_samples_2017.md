...
![Revit_Macro_Samples.rvt upgrade message](img/Revit_Macro_Samples_upgrade.png)
...
- [Problem](#2)
- [Solution – Sam comes to the rescue](#3)
...
![Macro manager problems](img/macro-manager.png)
