...
tags: ['csharp', 'elements', 'parameters', 'references', 'revit-api', 'rooms', 'schedules', 'selection', 'sheets', 'views', 'walls', 'windows']
source_file: "2034_sdk_2025.md"
original_url: "https://thebuildingcoder.typepad.com/blog/2034_sdk_2025.html"
---
...
- ContextMenu – create a customised add-in context menu, [cf. below](#7)
- DisallowEndWrapping – allow or disallow end wrapping at certain wall locations
- EditSketch – edit curves in sketches and add dimensions to the sketch using `SketchEditScope`
- NewMacro – generate, build end execute a Macro by `MacroManager`
Folders Removed:
- REX SDK
...
- Samples/Site
Modified:
- Macro Samples/GetTimeElapsed – previously separate samples and directories for CSharp and VBNet
Added:
...
![Visual Studio memory consumption growing](img/sdk_2025_vs_memory.png "Visual Studio memory consumption growing")
