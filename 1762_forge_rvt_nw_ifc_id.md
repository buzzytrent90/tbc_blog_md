...
![Jeremy on Jakobiger](img/808_jeremy_jakobiger_gipfelkreuz_600x800.jpg)
...
![RVT to NW element id in Forge](img/forge_model_derivative-nw-rvt.png)
...
![RVT element ids in Forge](img/forge_model_derivative-rvt.png)
...
![Element ids in Forge RVT, NW and IFC files](img/forge_model_derivative-nwd-rvt-ifc.png)
\*\*Answer:\*\* Yes.
