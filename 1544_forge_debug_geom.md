...
![ForgeFaver in Visual Studio Code](img/forgefader_in_vs_code.png)
...
![Line and vertex debug markers](img/forgefader_line_vertex_debug_marker_300.png)
Create a mesh to represent the floor top face and offset it up slightly above the floor surface:
![Floor top face mesh](img/forgefader_floor_top_face_mesh_250.png)
A debug helper displaying lines in the model representing the ray tracing rays:
![Ray tracing rays](img/forgefader_ray_trace_rays_250.png)
#### Next Steps
...
[Shader – Attributes](https://stemkoski.github.io/Three.js/Shader-Attributes.html)
