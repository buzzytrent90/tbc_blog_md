---
post_number: "1926"
title: "4.1.1. Duplicating Sheets"
slug: "whats_new_2022_1"
author: "Jeremy Tammik"
tags: ['elements', 'geometry', 'references', 'revit-api', 'schedules', 'sheets', 'views']
source_file: "1926_whats_new_2022_1.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1926_whats_new_2022_1.html"
---
...
* 4.1  [View API additions](#4.1)

+ 4.1.1.  [Duplicating Sheets](#4.1.1.)

* 4.2.  [Schedule API additions](#4.2.)

+ 4.2.1.  [Schedule heights on sheets](#4.2.1.)
+ 4.2.2.  [Managing schedule segments](#4.2.2.)

* 4.3.  [Worksharing API additions](#4.3.)

+ 4.3.1.  [Delete Workset API](#4.3.1.)

* 4.4.  [Import and Export API additions](#4.4.)

+ 4.4.1.  [AXM Import](#4.4.1.)
+ 4.4.2.  [OBJ & STL import/export](#4.4.2.)
...
![Revit 2022.1 API help on What's New](img/whats_new_2022_1.png "Revit 2022.1 API help on What's New")
