...
slug: "prompt_exception"
author: "Jeremy Tammik"
tags: ['elements', 'family', 'parameters', 'revit-api', 'sheets', 'transactions', 'views']
source_file: "1556_prompt_exception.md"
original_url: "https://thebuildingcoder.typepad.com/blog/1556_prompt_exception.html"
---
...
![Interrupt Process](img/interrupt_process.png)

By [Stephen Charles Thompson](//commons.wikimedia.org/wiki/User:Anon_lynx "User:Anon lynx") – Own work, [CC BY-SA 3.0](http://creativecommons.org/licenses/by-sa/3.0 "Creative Commons Attribution-Share Alike 3.0"), [Link](https://commons.wikimedia.org/w/index.php?curid=23385273)
...
```
![The Exception](img/the_exception.jpg)