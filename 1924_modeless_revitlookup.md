...
in [issue #92 – modeless window for lookup tools](https://github.com/jeremytammik/RevitLookup/issues/92):
...
- [93](https://github.com/jeremytammik/RevitLookup/pull/93) – Modeless windows
- [94](https://github.com/jeremytammik/RevitLookup/pull/94) – Fixed problem with tranferring focus to Revit when using selectors from modeless window
- [95](https://github.com/jeremytammik/RevitLookup/pull/95) – Handle multiple open documents at the same time
- [96](https://github.com/jeremytammik/RevitLookup/pull/96) – Fix for crash that happens when user cancel picking object in cmds SnoopPickFace, SnoopPickEdge, SnoopLinkedElement
- [97](https://github.com/jeremytammik/RevitLookup/pull/97) – Restore ability to snoop plan topologies
- [99](https://github.com/jeremytammik/RevitLookup/pull/99) – Eliminate warnings from [issue #98, warnings compiling...](https://github.com/jeremytammik/RevitLookup/issues/98)
...
![Modeless RevitLookup](img/RevitLookup_modeless.png "Modeless RevitLookup")
...
![Outdoor seatbelt](img/outdoor_seatbelt.jpg "Outdoor seatbelt")